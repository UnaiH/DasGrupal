...
public class WorkerGetUsersByCountryChess extends Worker {
    public WorkerGetUsersByCountryChess(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String server = "http://ec2-52-56-170-196.eu-west-2.compute.amazonaws.com/prehecho001/WEB/GroupProyect/getUsersByCountryChess.php";
        ...
        try {
            ...
            Log.i("Tag","StatusCode CountryChess: "+statusCode);
            if (statusCode == 200) {
