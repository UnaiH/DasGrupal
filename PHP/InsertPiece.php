...
$parametro2 = $_POST["type"];
$parametro3 = $_POST["posX"];
$parametro4 = $_POST["posY"];

# Ejecutar la sentencia SQL
$resultado = mysqli_query($con, "INSERT INTO Piece VALUES ($parametro,'$parametro2',$parametro3,$parametro4)");
